...
import { temperatureValue } from '../../utils/temperature.utils';
...
export class DetailedWeatherComponent {
  ...
  get temperatureOnRightUnit(): number {
    return temperatureValue(this.unit, this.weather.temp);
  }

  get feelsLiketemperature(): number {
    return temperatureValue(this.unit, this.weather.feelsLike);
  }
}
